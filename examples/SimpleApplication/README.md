...
The zip file should start with "SDK_for_Windows_".  Open the zip and extrat the .tar.xz file to any directory.  
	...
	Note:  Make sure the firmware version on the device is the same or newer than the SDK version.  You can check the firmware version by clicking the "General Data" link on the web based management:  https://<deviceip>/wbm  
