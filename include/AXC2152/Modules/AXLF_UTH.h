...
namespace PLCnext {
	...
	const ushort AXLF_MODULE_UTH8 = 0xA2;
	const ushort AXLF_MODULE_UTH4 = 0xA8;
	...
	public:
		...
		class UTH_Channel : public AXLInput
		{
		public:
	...
	{
	public:
		AXLF_UTH8(AXC2152* _axc, ushort _slot, uint pdInOffset, uint pdOutOffset);
	};

	class AXLF_UTH4 : public AXLF_UTH
	{
	public:
		AXLF_UTH4(AXC2152* _axc, ushort _slot, uint pdInOffset, uint pdOutOffset);
	};
}
