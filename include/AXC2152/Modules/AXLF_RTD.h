...
namespace PLCnext {
	...
	const ushort AXLF_MODULE_RTD4 = 0xA4;
	const ushort AXLF_MODULE_RTD8 = 0xA1;
	...
	{
	public:
		AXLF_RTD8(AXC2152* _axc, ushort _slot, uint pdInOffset);
	};

	class AXLF_RTD4 : public AXLF_RTD
	{
	public:
		AXLF_RTD4(AXC2152* _axc, ushort _slot, uint pdInOffset);
	};
}
