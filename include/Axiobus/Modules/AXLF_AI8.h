...
namespace PLCnext {
	...
	public:
		...
		class AI8_Channel : public AXLAnalogInput
		{
		public:
			AI8_Channel(char* _pd, AXLModule* module, uint channelNum);
		...
		AXLF_AI8(Axiobus* _axc, ushort _slot, uintptr_t pdInOffset, uintptr_t pdOutOffset);
		AXLF_AI8();
